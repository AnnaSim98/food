...
function calc() {
  ...
  function getStaticInformetion(selector, activeClass) {
    var elements = document.querySelectorAll("".concat(selector));
    elements.forEach(function (elem) {
  ...
  getStaticInformetion('#gender div', 'calculating__choose-item_active');
  getStaticInformetion('.calculating__choose_big div', 'calculating__choose-item_active');
...
function cards() {
  ...
  //     .then(data => {
  //         data.forEach(({imgß, altimg, title, descr, price}) => {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2021-01-25');
